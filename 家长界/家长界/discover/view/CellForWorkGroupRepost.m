...
- (void)setup{
    ...
    _labelIndustry.textColor = HWColor(96, 96, 96);
...
- (void)setModel:(YHWorkGroup *)model{
    ...
    [_repostView mas_updateConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(weakSelf.labelMore.mas_bottom).offset(repostVTop);
