...
@interface SiftView ()<JSDropDownMenuDataSource,JSDropDownMenuDelegate>{
...
- (void)viewLoad {
    ...
    JSDropDownMenu *menu = [[JSDropDownMenu alloc] initWithOrigin:CGPointMake(0, 0) andHeight:60];
    menu.indicatorColor = HWColor(175, 175, 175);
    menu.separatorColor = HWColor(210, 210, 210);
    menu.textColor = HWColor(53, 53, 53);
